...
export default function AccountCardHelper() {
  ...
  function buildSeamlessLoop(
    items: any[],
    spacing: number,
    animateFunc: (element: any) => gsap.core.Timeline
  ) {
