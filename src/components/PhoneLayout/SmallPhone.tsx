...
const Screen = styled.path`
    animation: screen_brighter 2s cubic-bezier(0.175, 0.885, 0.32, 1.275) infinite;
    filter: blur(15px);
    
    @keyframes screen_brighter {
        0% {
            fill: oklch(37.76% 0.012 264.08 / .3);
        }
...
export default function SmallPhone() {
    ...
    const [props, api] = useSpring(() => ({
        from: {
            transform: "rotateX(66deg) rotateZ(45deg) scale(.15)"
        }
    }))
    ...
    return (<>
        ...
        >
            <Frame
                $layerColors={
                    !isClick
                        ? layered_shadow(9, 0.3, 0.3, `oklch(70.4% 0.037 264.08)`) : "null"} />
            <Icon>
                <svg
                    width="376"
                    height="779"
                    ...
                    <path id="OuterFrame" d="M0 44C0 19.6995 19.6995 0 44 0H332C356.301 0 376 19.6995 376 44V735C376 759.301 356.301 779 332 779H44C19.6995 779 0 759.301 0 735V44Z" fill={"oklch(40% 0.037 264.08)"} />
