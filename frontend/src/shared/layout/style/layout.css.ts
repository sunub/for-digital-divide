...
globalStyle(`${openr}::before`, {
  ...
  width: "1.25rem",
  height: "1.25rem",
  background: vars.color.buttonActive,
...
export const frame = style([
  ...
  gridCenter,
  {
    ...
    borderRadius: "40px",
    boxShadow: `0px 24px 64px rgba(108, 62, 198, 0.15)`,
...
globalStyle(`${frame} > ${drawerContainer}`, {
