...
export default function IdCardSelectionStep({ onNext }: StepProps) {
  ...
  return (
    <Flex direction="column" gap="1rem" width="full">
      ...
      >
        원하시는 신분증 인증 방식을 선택해 주세요. 주민등록증을 활용하시는 것을
        권장합니다.
      </Text>
      ...
      >
        <Flex direction="column" alignItems="flex-start" gap="0.25rem">
          ...
          <span
            style={{ fontSize: "0.8rem", fontWeight: "normal", opacity: 0.8 }}
          >
            실물 주민등록증 정보 입력으로 검증
          </span>
        </Flex>
      ...
      <AlertDialog defaultOpen={false}>
        ...
        <AlertDialogContent>
          ...
          >
            ...
            >
              현재 시스템에서는 <strong>주민등록증 실물 인증</strong>만 바로
              이용하실 수 있습니다.
              <br />
              취소 버튼을 누르고 <strong>주민등록증 인증</strong>으로 계속
              진행해 주세요.
            </Text>
            <AlertCloseButton />
          </Flex>
        ...
        <AlertDialogContent>
          ...
          >
            ...
            >
              여권 인증은 현재 준비 중입니다.
              <br />
              원활한 가입 진행을 위해 <strong>주민등록증 인증</strong>을 활용해
              주시기 바랍니다.
            </Text>
            <AlertCloseButton />
          </Flex>
