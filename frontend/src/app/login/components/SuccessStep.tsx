...
export default function SuccessStep({ onNext }: StepProps) {
  return (
    <Flex direction="column" gap="1.5rem" width="full" alignItems="center" justifyContent="center">
      <div style={{
        width: "64px",
        height: "64px",
        borderRadius: "50%",
        ...
        <span style={{ fontSize: "2rem", color: "#fff", fontWeight: "bold" }}>✓</span>
      </div>

      <Flex direction="column" gap="0.5rem" alignItems="center">
        <Text as="h2" variant="title" style={{ fontSize: "1.5rem", fontWeight: "bold", textAlign: "center" }}>
          계좌 검증 완료
        </Text>
        <Text as="p" variant="body" style={{ color: "var(--color-text-description)", textAlign: "center", lineHeight: "1.4" }}>
          온보딩 검증이 완료되었습니다.<br />
